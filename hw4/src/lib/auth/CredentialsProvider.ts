...
export default CredentialsProvider({
  ...
  async authorize(credentials) {
    ...
    try {
      ...
      console.log("Wrong credentials format. Try again.");
      return null;
    }
    ...
    if (existedUser.provider !== "credentials") {
      console.log(`The account has registered with ${existedUser.provider}.`);
      return null;
    }
    if (!existedUser.hashedPassword) {
      console.log("The account has registered with social account.");
      return null;
    }

...
export type UpdateCardPayload = Partial<Omit<CardData, "id"> & { variant: string }>;

export type UpdateCardResponse = "OK";

export type DeleteListFromCardsPayload = { list_id: string; card_id: string[]; }

export type DeleteCardResponse = "OK";

export type GetListsResponse = Omit<ListData, "cards">[];

export type GetListResponse = Omit<ListData, "cards">;

export type CreateListPayload = Omit<ListData, "id" | "cards">;

export type CreateListResponse = Pick<ListData, "id">;

export type UpdateListPayload = Partial<Omit<ListData, "id" | "cards"> & { cards: string[], variant: string }>;
